                ...
                <div class="{{ $property->status == 'sold' ? 'property-sold' : '' }}">
                    ...
                    <a href="/property/{{ $property->slug }}" style="text-decoration:none; color:inherit;">
                        ...
                        <div class="property-card {{ $property->status == 'sold' ? 'property-disabled' : '' }}">
                            <div class="property-img" style="background-image:url('{{ $property->images->first()?->image_path  ? asset('storage/' . $property->images->first()->image_path)  : 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=1470&auto=format&fit=crop' }}')">
                                {{-- FEATURED BADGE --}}
