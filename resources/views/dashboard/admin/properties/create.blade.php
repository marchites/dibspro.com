...
<div class="section">
    ...
    <form action="/dashboard/properties/store" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="row">
            ...
            <div class="col-6 mb-3">
                ...
                <input type="number" name="building_size" class="form-control">
            </div>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="address-search" class="form-control" placeholder="Contoh: Asia Afrika Bandung">
        </div>
